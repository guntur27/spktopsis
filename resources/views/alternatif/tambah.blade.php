                    ...
                    <form action="{{ route('alternatif.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama"
                                ...
                                value="{{ old('nama') }}" placeholder="Max. 60 karakter">
                        ...
                        <div class="form-row">
                            <div class="form-group col-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="usia" id="usia"
                                        ...
                                        value="{{ old('usia') }}" placeholder="20 - 50">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="number" name="test" id="test"
                                    ...
                                    value="{{ old('test') }}" placeholder="0 - 100">
                                @if ($errors->has('test'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('test') }}
                                </div>
                            ...
                            <div class="form-group col-4">
                                ...
                                <select name="pendidikan" id="pendidikan"
                                    ...
                                    <option value="{{ $grade_pendidikan->id }}"
                                        {{ old('pendidikan')==$grade_pendidikan->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="masa_kerja" id="masa_kerja"
                                        ...
                                        value="{{ old('masa_kerja') }}" placeholder="2 - 20">
                                    <div class="input-group-append">
                                        <span class="input-group-text">tahun</span>
                                    </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <div class="input-group">
                                    <input type="number" name="absensi" id="absensi"
                                        ...
                                        value="{{ old('absensi') }}" placeholder="0 - 100">
                                    <div class="input-group-append">
